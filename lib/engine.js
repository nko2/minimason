module.exports = function (platform) {
  ...
  return {
    ...
    spriteContext: require('jsgamebench/webgl_sprite').createContext(gl, createSpriteProgram(gl))
...
//    spriteContext: reQuire('jsgamebench/webgl_sprite').createBatchingContext(gl, 500)
  ...
  function loadSpriteMap(spriteSpec, callback) {
    console.log("LOADING SPRITE MAP");
      ...
      callback(null, function makeSprite(name) {
        ...
        return new SpriteClass(this, texture, sprites);
      });
    });
  }
